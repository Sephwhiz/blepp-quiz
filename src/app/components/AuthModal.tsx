    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 p-4 backdrop-blur-sm">
      <div className="bg-gray-900 border border-teal-500 rounded-xl max-w-md w-full p-6 space-y-4 shadow-2xl relative">
        ...
        <button
          ...
          className="w-full py-3 bg-white hover:bg-gray-100 disabled:bg-gray-300 text-gray-900 rounded-lg font-medium transition flex items-center justify-center gap-2"
        >
          {googleLoading ? (
