    ...
    try {
      ...
      const { error } = await supabase.auth.signInWithOAuth({
        ...
        options: { 
          ...
          queryParams: {
            prompt: 'consent', // Forces Google to always ask for account selection
          }
        }
      })
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-950 p-4">
      ...
      <div className="w-full max-w-md bg-gray-900 border border-gray-800 rounded-xl p-8 shadow-2xl">
        ...
        {/* Social Buttons - FIXED SIZE & CENTERED */}
        <div className="flex justify-center">
          <button
            type="button"
            onClick={() => handleOAuth('google')}
            className="flex items-center justify-center gap-2 bg-gray-800 hover:bg-gray-700 border border-gray-700 text-white py-2.5 px-6 rounded-lg transition w-full max-w-[280px]"
          >
